...
#SBATCH --output=hpc/logs/train/%x_%j.log
...
CONFIG=local_configs/dinov3/dinov3_hf_convnext_base_tv3s_frozen.480x480.vspw2.160k.py
WORK_DIR=dinov3_convnext_base_tv3s_frozen_2sample_2gpu_iter160k_lr6e-5
