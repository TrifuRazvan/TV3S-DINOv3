...
model = dict(
    ...
    pretrained='pretrained/swins/swin_tiny_patch4_window7_224_22k.pth',
    backbone=dict(
        type='d2_Swint',
        style='pytorch'),
    decode_head=dict(
...
log_config = dict(_delete_=True, interval=100, hooks=[dict(type='TextLoggerHook', by_epoch=False)])
